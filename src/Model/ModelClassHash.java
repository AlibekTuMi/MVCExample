...
public class ModelClassHash implements iGetModel {
    ...
    private HashMap<Integer, Student> hashStudent;

    /**
     * Конструктор
     * 
     * @param hashStudent - коллекция студентов
     */
    public ModelClassHash(HashMap<Integer, Student> hashStudent) {
        this.hashStudent = hashStudent;
    }

    // Метод, который преобразует коллекцию студентов в список
    @Override
    public List<Student> getStudents() {

        List<Student> studentsList = new ArrayList<>(hashStudent.values());
        return studentsList;
    }
